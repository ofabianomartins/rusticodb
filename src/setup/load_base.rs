...
pub fn setup_base(machine: &mut Machine) {
    ...
    tuples.push(get_tuple_sequence(1u64, &Config::sysdb(), &Config::sysdb_table_databases(), &String::from("id"), &String::from("rusticodb_databases_id"), 1u64));
    tuples.push(get_tuple_sequence(2u64, &Config::sysdb(), &Config::sysdb_table_tables()   , &String::from("id"), &String::from("rusticodb_tables_id"), 1u64));
    tuples.push(get_tuple_sequence(3u64, &Config::sysdb(), &Config::sysdb_table_columns()  , &String::from("id"), &String::from("rusticodb_columns_id"), 29u64));
    tuples.push(get_tuple_sequence(4u64, &Config::sysdb(), &Config::sysdb_table_sequences(), &String::from("id"), &String::from("rusticodb_sequences_id"), 6u64));
    tuples.push(get_tuple_sequence(5u64, &Config::sysdb(), &Config::sysdb_table_indexes()  , &String::from("id"), &String::from("rusticodb_indexes_id"), 1u64));
    ...
    let mut tuples: Vec<Tuple> = Vec::new();
    tuples.push(get_tuple_column(01u64, &Config::sysdb(), &Config::sysdb_table_databases(), &String::from("id"), &String::from("UNSIGNED BIGINT"), true, true, true, &String::from("")));
    ...
    tuples.push(get_tuple_column(03u64, &Config::sysdb(), &Config::sysdb_table_tables(), &String::from("id"), &String::from("UNSIGNED BIGINT"), true, true, true, &String::from("")));
    ...
    tuples.push(get_tuple_column(08u64, &Config::sysdb(), &Config::sysdb_table_columns(), &String::from("id"), &String::from("UNSIGNED BIGINT"), true, true, true, &String::from("")));
    ...
    tuples.push(get_tuple_column(13u64, &Config::sysdb(), &Config::sysdb_table_columns(), &String::from("not_null"), &String::from("UNSIGNED TINYINT"), true, false, false, &String::from("")));
    tuples.push(get_tuple_column(14u64, &Config::sysdb(), &Config::sysdb_table_columns(), &String::from("unique"), &String::from("UNSIGNED TINYINT"), true, false, false, &String::from("")));
    tuples.push(get_tuple_column(15u64, &Config::sysdb(), &Config::sysdb_table_columns(), &String::from("primary_key"), &String::from("UNSIGNED TINYINT"), true, false, false, &String::from("")));
    ...
    tuples.push(get_tuple_column(17u64, &Config::sysdb(), &Config::sysdb_table_sequences(), &String::from("id"), &String::from("UNSIGNED BIGINT"), true, true, true, &String::from("")));
    ...
    tuples.push(get_tuple_column(22u64, &Config::sysdb(), &Config::sysdb_table_sequences(), &String::from("next_id"), &String::from("UNSIGNED BIGINT"), true, false, false, &String::from("")));

    tuples.push(get_tuple_column(23u64, &Config::sysdb(), &Config::sysdb_table_indexes(), &String::from("id"), &String::from("UNSIGNED BIGINT"), true, true, true, &String::from("")));
