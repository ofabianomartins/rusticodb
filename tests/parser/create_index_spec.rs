...
pub fn test_index_creation_if_not_exists() {
    ...
    let _ = sql_executor.parse_command("CREATE INDEX index1 ON table1(attr1)");

    let result_set_create = sql_executor.parse_command("CREATE INDEX IF NOT EXISTS index1 ON table1(attr1)");
...
pub fn test_index_creation_if_exists() {
    ...
    let result_set_create = sql_executor.parse_command("CREATE INDEX index1 ON table1(attr1)");
